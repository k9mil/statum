...
def generate_token(*bearer: str) -> dict[str, str]:
    ...
    if bearer:
        ...
        auth_url: str = f"https://id.twitch.tv/oauth2/token?client_id={Config.CLIENT_ID}&client_secret={Config.AUTH_KEY}&grant_type=authorization_code&redirect_uri=https://statum-demo.tk/&code={full_url.args['code']}"
